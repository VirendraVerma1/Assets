...
public class MoveBehaviour : GenericBehaviour
{
	...
	public void UseDoubleSpeedAbility()
	{
		runSpeed*=2;
	}

	public void DisableDoubleSpeedAbility()
	{
		runSpeed=tempRun;
	}

	bool isjumping=false;
	public void OnAndroidJumpButtonPressed()
	{
		isjumping=true;
	}
	...
	void Update()
	{
		...
		if(isAndroid)
		{
			if (!jump && isjumping && behaviourManager.IsCurrentBehaviour(this.behaviourCode) && !behaviourManager.IsOverriding())
			{
				jump = true;
				isjumping=false;
			}
